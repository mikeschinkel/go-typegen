...
func TestCodeBuilder_Marshal(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			value: &recur,
			want:  `&typegen.recurStruct{name:"root",recur:&typegen.recurStruct{name:"root",recur:nil/*** recursion ***/,extra:"whatever",},extra:"whatever",}`,
		},
		{
		...
		},
		{
			...
			value: &testStruct{},
			want:  `&typegen.testStruct{Int:0,String:"",}`,
		},
		{
			name: "interface{}{}",
